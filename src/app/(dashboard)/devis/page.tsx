...
export default function DevisPage() {
  const [devis, setDevis] = useState<Devis[]>([
    { 
      ...
      prestations: [{ description: 'Consultation Technique', prixUnitaire: 500, quantite: 1 }], 
      devise: '€', 
      date: '28/03/2026', 
      echeance: '27/04/2026' 
    },
  ...
  useEffect(() => {
    if (isModalOpen) {
      ...
      const validityAuto = nextMonth.toISOString().split('T')[0];
      setFormData(prev => ({ ...prev, echeance: validityAuto }));
    }
  }, [isModalOpen]);
          ...
          <div className="modal-content custom-modal">
            ...
            <form onSubmit={handleSave} className="modern-form">
              ...
              <div className="modal-actions">
                ...
                <button type="submit" className="btn-submit">Créer le devis</button>
              </div>
            </form>
          </div>
        </div>
